...
"""
    components.html(story_component_css + html, height=6200, scrolling=False)
...
"""
    components.html(aroma_css + aroma_html, height=7600, scrolling=False)
